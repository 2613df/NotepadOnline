...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light fixed-top" style="background-color: #5ed5d1;">
		<a class="navbar-brand" href="./">
			<!--img src="logo.svg" width="30" height="30" alt=""--><?php print $name; ?> - 94Notepad</a>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
		  ...
		  <form class="form-inline my-2 my-lg-0" action="/<?php echo $name;?>" method="POST">
			<input type="text" name="goto" class="form-control" placeholder="笔记后缀,如 <?php echo $name;?>">
